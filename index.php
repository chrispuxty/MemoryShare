...
if($path=="media"	) echo '$(".button:eq(0)").delay(7190).animate({opacity: 0},250,function(){$(".button:eq(0)").animate({opacity: 1},250);});
$(".button:eq(1)").delay(10202).animate({opacity: 0},250,function(){$(".button:eq(1)").animate({opacity: 1},250);});
$(".button:eq(2)").delay(13413).animate({opacity: 0},250,function(){$(".button:eq(2)").animate({opacity: 1},250);});
$(".button:eq(3)").delay(16672).animate({opacity: 0},250,function(){$(".button:eq(3)").animate({opacity: 1},250);});
var x = setTimeout(function(){
$(".button:eq(0)").delay(7190).animate({opacity: 0},250,function(){$(".button:eq(0)").animate({opacity: 1},250);});
$(".button:eq(1)").delay(10202).animate({opacity: 0},250,function(){$(".button:eq(1)").animate({opacity: 1},250);});
$(".button:eq(2)").delay(13413).animate({opacity: 0},250,function(){$(".button:eq(2)").animate({opacity: 1},250);});
$(".button:eq(3)").delay(16672).animate({opacity: 0},250,function(){$(".button:eq(3)").animate({opacity: 1},250);});
},26000);';else echo '$(".button:eq(0)").delay(6483).animate({opacity: 0},250,function(){$(".button:eq(0)").animate({opacity: 1},250);});
